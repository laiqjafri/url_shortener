...
Follow following set of commands to set this rails project up on your local:
...
Fire up the browser and go to http://localhost:3000/. If your local server address is different, then change the base_url config in development.rb accordingly.
